...
function resetAll() {
    ...
    document.getElementById("matrix-9").value = "9";

    document.getElementById("matrix-10").value = "1";
    document.getElementById("matrix-11").value = "2";
    document.getElementById("matrix-12").value = "3";
    document.getElementById("matrix-13").value = "4";
    document.getElementById("matrix-14").value = "5";
    document.getElementById("matrix-15").value = "6";
    document.getElementById("matrix-16").value = "7";
    document.getElementById("matrix-17").value = "8";
    document.getElementById("matrix-18").value = "9";
